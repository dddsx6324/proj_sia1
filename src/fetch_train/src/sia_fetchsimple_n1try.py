...
if __name__ == '__main__':
    ...
    min_episodes = rospy.get_param('/sia_fetch/min_episodes')
    max_env_steps = None
    gamma = rospy.get_param('/sia_fetch/gamma')
    epsilon = rospy.get_param('/sia_fetch/epsilon')
    epsilon_min = rospy.get_param('/sia_fetch/epsilon_min')
    epsilon_log_decay = rospy.get_param('/sia_fetch/epsilon_decay')
    alpha = rospy.get_param('/sia_fetch/alpha')
    alpha_decay = rospy.get_param('/sia_fetch/alpha_decay')
    batch_size = rospy.get_param('/sia_fetch/batch_size')
    monitor = rospy.get_param('/sia_fetch/monitor')
    quiet = rospy.get_param('/sia_fetch/quiet')
